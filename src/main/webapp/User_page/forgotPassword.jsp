        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="page-login account-box-shadow">
                ...
                <div id="recover-password" class="form-signup">
                    ...
                    <form action="/LTWeb_Nhom9/ForgotPassword" method="post">
<%--                    đổi mật khẩu error--%>
                        <%
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 fix-clear">
                        <div class="footer-widget">
                            ...
                            <ul class="list-menu has-click">
                                ...
                                <li><a href="chinh-sach-doi-tra-bao-hanh.html" title="Chính sách đổi trả, bảo hành"
                                       rel="nofollow">Chính sách đổi trả, bảo hành</a></li>

                                <li><a href="chinh-sach-van-chuyen-va-doi-tra.html"
                                       title="Chính sách vận chuyển và đổi trả" rel="nofollow">Chính sách vận chuyển và
                                    đổi trả</a></li>

                                <li><a href="chinh-sach.html" title="Chính sách bảo mật" rel="nofollow">Chính sách bảo
                                    mật</a></li>

                                <li><a href="dieu-khoan.html" title="Quy định sử dụng" rel="nofollow">Quy định sử
                                    dụng</a>
                                </li>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 fix-clear">
                        <div class="footer-widget footer-contact">
                            ...
                            <ul class="list-menu">
                                ...
                                <li class="hidden-md hidden-sm hidden-lg"><strong>Hotline</strong><a href="#"
                                                                                                     title="0123456789">0123456789</a>
                                </li>
                                <li><strong>Email</strong><a href="#" title="19130169@st.hcmuaf.edu.vn">19130169@st.hcmuaf.edu.vn</a>
                                </li>
