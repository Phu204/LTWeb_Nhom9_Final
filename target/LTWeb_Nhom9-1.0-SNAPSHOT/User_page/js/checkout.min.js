    ...
    function(n) {
        ...
        var r = {
            ...
            loadBank: function(n) {
                ...
                if (n === "qr") {
                    if (t.loadedQrBank) return
                } else if (n === "inst") {
                    if (t.loadedBank) return;
                    r = "/payon/banks.json"
                }
            ...
            changeCycle: function(n) {
                ...
                if (n != u.payon_cycle && (u.payon_cycle = n, r = u.listFee.find(function(t) {
                    ...
                    var f = $(".fee-mobile"),
                        e = $("#bank-list__fee-mobile").text(),
                        o = {
                            month: r.month,
                            amount_month: t((r.amount_payment + r.fee) / r.month),
                            amount_total: t(r.amount_payment + r.fee),
            ...
            renderMobileInst: function() {
                var n = this,
                    o = $(".list-cycle-mobile"),
                    s = $("#bank-list__cycle-mobile").text(),
                    h = $(".fee-mobile"),
                    c = $("#bank-list__fee-mobile").text(),
                    u, r, f, e;
                for (n.payon_cycle = n.listFee[0].month, n.payon_userfee = n.listFee[0].userfee, $("#payon_cycle").val(n.listFee[0].month), $("#payon_userfee").val(n.listFee[0].userfee), u = [], r = 0; r < n.listFee.length; r++) f = n.listFee[r], u.push(i(s, f));
                o.html(u.join(""));
                e = {
                    month: n.listFee[0].month,
                    amount_month: t((n.listFee[0].amount_payment + n.listFee[0].fee) / n.listFee[0].month),
                    amount_total: t(n.listFee[0].amount_payment + n.listFee[0].fee),
                    amount_deviant: t(n.listFee[0].fee)
                };
                h.html(i(c, e));
                Twine.refresh();
                Twine.bind()
