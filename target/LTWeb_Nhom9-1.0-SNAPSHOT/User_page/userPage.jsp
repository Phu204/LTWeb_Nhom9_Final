...
<head>
    ...
    <link href="css/evo-index.scss.css" rel="stylesheet" type="text/css"/>
                    ...
                    <ul>
                        ...
                        <c:if test="${sessionScope.auth != null }">
                            <li><a rel="nofollow" href="LogOut" title="Đăng xuất"><i class="fa fa-sign-out"
                                                                                     aria-hidden="true"></i> Đăng
                                xuất</a></li>
                            <li><a rel="nofollow" href="#" title="hello name"><i class="fa fa-user"
                                                                                 aria-hidden="true"></i>
...
<c:if test="${sessionScope.auth != null && sessionScope.auth.role == 1}">
    <div class="user-page">
        <h1 style="color: #2bf525">Is User ${sessionScope.auth.name}</h1>
    </div>
    <div class="change-pass">
<%--        <button rel="nofollow" class="btn btn-style btn-blues" href="changePassword.jsp">đổi mật khẩu user</button>--%>
...
<c:if test="${sessionScope.auth == null}">
    <div class="user-page">
        <h1 style="color: #f52525">Not login</h1>
    </div>
</c:if>
</body>
</html>
